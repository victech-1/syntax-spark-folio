...
-- Create contact submissions table with subject field
...
CREATE POLICY "Authenticated users can update contact submissions" ON public.contact_submissions FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "Authenticated users can delete contact submissions" ON public.contact_submissions FOR DELETE USING (auth.role() = 'authenticated');
...
CREATE POLICY "Authenticated users can insert personal info" ON public.personal_info FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "Authenticated users can update personal info" ON public.personal_info FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "Authenticated users can delete personal info" ON public.personal_info FOR DELETE USING (auth.role() = 'authenticated');
